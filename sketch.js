...
function prepareToken() {
   ...
   //The Karmic Lottery
  AndromedaData = hl.randomElement(AndromedaDatas);
if (AndromedaData.title === "[timeLink]" ){
    var Time = hl.randomElement(AndromedaData.data)
   AndromedaText = hl.randomElement(Time.dates);
     AndromedaTitle = AndromedaData.title;
  era = Time.title;
  } 
  else {
  AndromedaTitle = AndromedaData.title;
  AndromedaText = hl.randomElement(AndromedaData.data);
  } 
  ...
  let colorMods = [psyColors, creaColors, energyColors, timeColors, magicColors, spaceColors];
     ...
     //backgroundColor
couleurI = AndromedaDatas.indexOf(AndromedaData);
c77 = colorMods[couleurI]; 
